...
## R Café June 2023: **Troubleshooting walk-in session**

- **Date:** 20th June 2023
- **Time:** 3 PM – 4:30 PM CEST
- **Place:** TU Delft BK Building, BG.West.350
- **Description:** A walk-in session dedicated to Data Carpentries' participants. Work on your project after the workshop and pass by the R Café to share your analysis, experiences, problems, ask questions, etc. You don't have a project to work on yet? You can have a go at one of those:
  - [30 day map challenge](https://30daymapchallenge.com/)  - Geospatial Data Carpentry
  -	[advent calendaR](https://github.com/kiirsti/ggplot_adventcalendaR/tree/main) - Data Carpentry for Social Sciences and Humanities

- **Registration:** No registration needed


<a href='outlook/Rcafe-jun2023.ics' download="R-Cafe">
