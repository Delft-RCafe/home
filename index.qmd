...
- **Presenter:** TBD
- **Description:** We will start with a short demonstration of  [#tidytuesday](https://github.com/rfordatascience/tidytuesday) project. We will then continue to jointly jam the data solutions on one of the real-world datasets. 
